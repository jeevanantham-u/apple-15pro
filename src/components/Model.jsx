...
const Model = () => {
    ...
    // timeline animaion for changing small 3d to big 3d;
    const tl = gsap.timeline();

    useEffect(() => {
        if (size === 'large') {
            animationWithGsapTl(tl, small, smallRotation, '#view1', '#view2', {
        ...
        if (size === 'small') {
            animationWithGsapTl(tl, large, largeRotation, '#view2', '#view1', {
